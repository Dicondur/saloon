...
namespace Hair.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public StaffsController(HairContext context)
        {
            _context = context;
        }
        ...
        {
            var hairContext = _context.Staff.Include(s => s.Customer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffId,CustomerId,DateHired,DateTerminated,ReasonForTermination,IsStylist,HourlyChargeoutRate,HourlySalary,Comments")] Staff staff)
        {
            if (id != staff.StaffId)
            {
                return NotFound();
