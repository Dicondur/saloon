...
namespace Hair.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(HairContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,Name,Phone,Email,StreetAddress,City,PostalCode,Province,PreferredStylist,Comments,CanAdvertiseOnline")] Customer customer)
        {
